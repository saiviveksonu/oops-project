...
function Book(names, author, type) {
    this.names = names;
    this.author = author;
    this.type = type;
};

// creating a display constructor
function Display() {

}
Display.prototype.add = (book1) => {
...
Display.prototype.validate = (book1) => {
...
Display.prototype.show = (type,message1) => {
